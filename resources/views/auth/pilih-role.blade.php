...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Appkonkos') }} - Pilih Role</title>
        ...
        <div class="relative overflow-hidden">
            ...
            <header class="mx-auto flex max-w-7xl items-center justify-between px-4 py-5 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('auth.pilih-role') }}" class="rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm transition hover:border-slate-300 hover:bg-slate-100">
                        Login
                    </a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="rounded-full bg-cyan-700 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-cyan-800">
                            Daftar
                        </a>
                    @endif
                </div>
                ...
                <section class="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
                    <div>
                        ...
                        <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                            ...
                            <a href="{{ route('auth.pilih-role') }}" class="rounded-full border border-slate-300 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-400 hover:bg-slate-100">
