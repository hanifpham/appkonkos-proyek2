        ...
        <section class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
            <div class="group relative overflow-hidden rounded-[18px] border border-[#edf0f4] bg-white p-6 shadow-[0_6px_18px_rgba(15,23,42,0.05)] transition-colors dark:border-slate-700 dark:bg-slate-900">
                ...
                <div class="relative z-10">
                    <p class="mb-2 text-[14px] font-medium text-slate-500 dark:text-slate-400">Saldo Tersisa</p>
                    <h3 class="mb-6 text-[22px] font-bold leading-tight text-slate-900 dark:text-white">Rp {{ number_format($saldo, 0, ',', '.') }}</h3>
            ...
            <div class="group relative overflow-hidden rounded-[18px] border border-[#edf0f4] bg-white p-6 shadow-[0_6px_18px_rgba(15,23,42,0.05)] transition-colors dark:border-slate-700 dark:bg-slate-900">
                ...
                <div class="relative z-10 flex h-full flex-col justify-between">
                    <div>
                        <p class="mb-2 text-[14px] font-medium text-slate-500 dark:text-slate-400">Total Properti</p>
                        <h3 class="text-[22px] font-bold leading-tight text-slate-900 dark:text-white">{{ $totalProperti }} Properti</h3>
                    </div>
            ...
            <div class="group relative overflow-hidden rounded-[18px] border border-[#edf0f4] bg-white p-6 shadow-[0_6px_18px_rgba(15,23,42,0.05)] transition-colors dark:border-slate-700 dark:bg-slate-900">
                ...
                <div class="relative z-10 flex h-full flex-col justify-between">
                    <div>
                        <p class="mb-2 text-[14px] font-medium text-slate-500 dark:text-slate-400">Sisa Kamar Kosong</p>
                        <h3 class="text-[22px] font-bold leading-tight text-slate-900 dark:text-white">{{ $sisaKamar }} Kamar</h3>
                    </div>
                    <div class="mt-6 flex items-center gap-2 text-[14px] text-slate-500 dark:text-slate-400">
                        <span class="h-2.5 w-2.5 rounded-full bg-emerald-500"></span>
                        Dari total {{ $totalKamar }} kamar
                    </div>
                </div>
            </div>
