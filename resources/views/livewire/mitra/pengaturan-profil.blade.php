    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-12">
        <div class="space-y-6 lg:col-span-4">
            <div class="flex flex-col items-center rounded-xl border border-gray-100 bg-white p-6 text-center shadow-sm dark:border-gray-700 dark:bg-slate-900">
                ...
                @if ($foto_baru)
                    <div class="mb-4 w-full rounded-xl border border-blue-100 bg-blue-50 p-3 text-left dark:border-blue-900/40 dark:bg-blue-900/20">
                        <p class="text-xs font-semibold text-[#0F4C81] dark:text-blue-300">Foto baru sudah dipilih.</p>
                        <p class="mt-1 text-[11px] leading-4 text-slate-500 dark:text-slate-400">Klik tombol simpan agar foto profil tersimpan permanen dan tampil di halaman detail properti.</p>
                        <button
                            type="button"
                            wire:click="simpanFotoProfil"
                            wire:loading.attr="disabled"
                            wire:target="simpanFotoProfil,foto_baru"
                            class="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[#0F4C81] px-4 py-2.5 text-xs font-bold text-white shadow-sm transition hover:bg-[#0d3f6d] disabled:cursor-wait disabled:opacity-70"
                        >
                            <span wire:loading.remove wire:target="simpanFotoProfil" class="material-symbols-outlined text-base">save</span>
                            <span wire:loading wire:target="simpanFotoProfil" class="material-symbols-outlined animate-spin text-base">sync</span>
                            <span wire:loading.remove wire:target="simpanFotoProfil">Simpan Foto Profil</span>
                            <span wire:loading wire:target="simpanFotoProfil">Menyimpan...</span>
                        </button>
                    </div>
                @endif
