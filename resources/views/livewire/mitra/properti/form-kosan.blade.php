                        ...
                        @if($tipe_properti === 'kosan')
                            <div class="space-y-1.5 mt-4">
                                <label class="text-xs font-semibold text-gray-700 dark:text-gray-300">
                                    Kategori Kos <span class="text-red-500">*</span>
                                </label>
                                <select wire:model="jenis_kos" class="w-full bg-gray-50 dark:bg-slate-800 border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:ring-primary focus:border-primary px-4 py-2.5 transition-all">
                                ...
                                @error('jenis_kos') <span class="text-[10px] text-red-500 mt-1">{{ $message }}</span> @enderror
                            </div>
                        @endif
