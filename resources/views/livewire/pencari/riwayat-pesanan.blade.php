        ...
        <div class="w-full md:w-[320px] shrink-0">
            <div class="bg-white dark:bg-slate-900 rounded-[24px] shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden mb-6 transition-colors">
                ...
                <div class="px-6 pb-6 relative -mt-12 text-center">
                    <div class="relative inline-block mb-3">
                        ...
                        <img src="{{ '/storage/' . ltrim($user->profile_photo_path, '/') }}" alt="Foto Profil" class="w-24 h-24 rounded-full mx-auto object-cover ring-4 ring-white dark:ring-slate-900 shadow-md">
                        @else
            ...
            <div class="bg-white dark:bg-slate-900 rounded-[24px] shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden py-3 transition-colors">
                <nav class="flex flex-col px-3 gap-1">
                    <a href="{{ route('pencari.profil') }}" wire:navigate class="px-4 py-3 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-slate-900 dark:hover:text-slate-200 rounded-xl font-medium flex items-center gap-3 transition-colors">
                    ...
                    <a href="{{ url('riwayat-pesanan') }}" wire:navigate class="px-4 py-3 bg-blue-50 dark:bg-slate-800 text-[#1967d2] dark:text-blue-400 rounded-xl font-bold flex items-center gap-3 transition-colors">
