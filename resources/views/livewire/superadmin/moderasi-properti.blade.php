...
<div class="flex-1 space-y-8 overflow-y-auto p-8">
    ...
    <section
        class="overflow-hidden rounded-xl border border-gray-100 bg-white shadow-md dark:border-gray-700 dark:bg-slate-900">
            ...
            <div class="flex flex-wrap items-center justify-end gap-4">
                <div class="relative">
                    <input type="text" wire:model.live.debounce.300ms="search"
                        class="w-64 rounded-lg border border-gray-300 bg-gray-50 py-2 pl-10 pr-4 text-sm transition-all focus:border-primary focus:ring-primary dark:border-gray-600 dark:bg-slate-900"
                        placeholder="Cari ID, Nama, Pemilik..." />
                    <span
                        class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[18px] text-gray-400">search</span>
                </div>

                <select wire:model.live="filterTipe" class="w-44 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 transition-all focus:border-primary focus:ring-primary dark:border-gray-600 dark:bg-slate-900 dark:text-gray-300">
                    <option value="">Semua Tipe</option>
                    <option value="kosan">Kosan</option>
                    <option value="kontrakan">Kontrakan</option>
                </select>

                <select wire:model.live="filterStatus" class="w-44 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 transition-all focus:border-primary focus:ring-primary dark:border-gray-600 dark:bg-slate-900 dark:text-gray-300">
                ...
                <button
                    ...
                    class="flex items-center gap-2 rounded-lg bg-[#113C7A] px-4 py-2 text-sm font-bold text-white shadow-md transition-colors hover:bg-[#0d2f60]"
                >
                                ...
                                <td class="px-6 py-5">
                                    <div class="flex items-center gap-3">
                                        <div
                                            ...
                                            <img src="{{ $this->getPemilikPhotoUrl($properti) }}" alt="{{ $properti->nama_pemilik ?: 'User' }}" class="h-full w-full object-cover">
                                        </div>
