...
>>>>>>> 61d1b33121855090630d4359a279d3293e8ff5f3
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ $social['url'] }}" class="group relative flex h-10 w-10 items-center justify-center rounded-full border border-slate-100 bg-white shadow-sm transition-all hover:-translate-y-1 hover:border-transparent hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900" aria-label="{{ $social['icon'] }}">
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4">
                    @foreach(['Cari Kos & Kontrakan', 'Manajemen Sewa', 'Sistem Booking Online', 'Ulasan & Rating'] as $item)
                    <li>
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="{{ $item['url'] }}" class="group flex items-center text-sm font-bold text-slate-500 transition hover:text-[#1967d2] dark:text-slate-400 dark:hover:text-blue-400">
                            <span class="h-1.5 w-0 rounded-full bg-[#1967d2] transition-all group-hover:mr-2 group-hover:w-1.5"></span>
                            {{ $item['label'] }}
                        </a>
                    </li>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col items-center justify-between gap-6 md:flex-row">
                <p class="text-sm font-bold text-slate-500 dark:text-slate-400">
                    &copy; {{ date('Y') }} <span class="text-[#1967d2]">APPKONKOS</span>. All rights reserved.
                </p>
