...
<section class="bg-white py-16" id="rekomendasi-kontrakan">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-end justify-between">
            ...
            <a href="{{ route('cari', ['tipe' => 'Kontrakan']) }}" class="hidden items-center gap-1 text-sm font-semibold text-[#0EA5E9] transition hover:text-[#3B82F6] sm:inline-flex" id="kontrakan-lihat-semua">
                Lihat Semua
        ...
        <div class="mt-6 text-center sm:hidden">
            <a href="{{ route('cari', ['tipe' => 'Kontrakan']) }}" class="inline-flex items-center gap-1 text-sm font-semibold text-[#0EA5E9]">
