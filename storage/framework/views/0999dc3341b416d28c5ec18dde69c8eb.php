            ...
            <div class="mb-8 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
                <form action="<?php echo e(route('cari')); ?>" method="GET" class="flex flex-col gap-4 md:flex-row md:items-center">
                    ...
                    <div class="relative flex-1">
                        ...
                        <input type="text" name="lokasi" value="<?php echo e($request->query('lokasi')); ?>" placeholder="Cari lokasi atau nama properti..." class="w-full rounded-xl border border-[#e5e7eb] bg-slate-50 py-3 pl-11 pr-4 text-sm text-[#090a0b] transition focus:border-[#1967d2] focus:bg-white focus:outline-none focus:ring-1 focus:ring-[#1967d2]">
                    </div>
                    ...
                    <article class="group overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-slate-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
                        ...
                        <div class="p-4">
                            <div class="flex items-center justify-between">
                                <span class="text-xs font-bold uppercase tracking-wide <?php echo e($properti->tipe_properti === 'kos' ? 'text-[#1967d2]' : 'text-[#32baff]'); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\appkonkos_2\resources\views/public/cari.blade.php ENDPATH**/ ?>