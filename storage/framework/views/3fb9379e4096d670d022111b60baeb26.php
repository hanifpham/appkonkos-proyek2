...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Appkonkos')); ?> - <?php echo $__env->yieldContent('mitra-title', 'Dashboard Mitra'); ?></title>
    ...
    >
        ...
        <div class="flex h-screen w-full overflow-hidden bg-[#f5f7fb] dark:bg-[#10192d]">
            ...
            <aside
                class="fixed inset-y-0 left-0 z-50 flex <?php echo e($sidebarWidthClass); ?> flex-col bg-[#163f7a] transition-transform duration-300 dark:bg-[#0a1224] lg:translate-x-0"
                ...
                <div class="flex min-h-[100px] shrink-0 items-center border-b border-white px-6">
                    <div class="flex items-center gap-3">
                        <div class="flex h-11 w-11 items-center justify-center overflow-hidden rounded-full bg-white shadow-lg shadow-black/10">
                            <img class="h-10 w-10 object-contain" src="<?php echo e(asset('images/appkonkos.png')); ?>" alt="<?php echo e(config('app.name', 'APPKONKOS')); ?>">
                        </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $sidebarItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        >
                            <div class="flex min-w-0 flex-1 items-start gap-3">
                                <span class="material-symbols-outlined mt-0.5 shrink-0 text-[20px]"><?php echo e($item['icon']); ?></span>
                                <span class="min-w-0 break-words pr-3 <?php echo e($user?->role === 'superadmin' ? 'text-[13.5px]' : ''); ?>"><?php echo e($item['label']); ?></span>
                            </div>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item['badge'] !== null): ?>
                                <span class="ml-2 mt-0.5 shrink-0 rounded-full bg-red-500 px-1.5 py-0.5 text-[10px] font-bold text-white"><?php echo e($item['badge']); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </nav>

                <div class="shrink-0 border-t border-white/10 bg-[#14366a] <?php echo e($sidebarProfileWrapperClass); ?> dark:bg-black/20">
                    <div class="mb-3 flex items-center <?php echo e($sidebarProfileGapClass); ?>">
                        <img alt="<?php echo e($user?->name); ?>" class="<?php echo e($sidebarProfileImageClass); ?> rounded-full border-2 border-white/30 object-cover shadow-sm" src="<?php echo e($profilePhotoUrl); ?>" data-appkonkos-profile-photo>
                        <div class="min-w-0 flex-1">
                            <span class="block truncate <?php echo e($sidebarProfileNameClass); ?> font-semibold text-white"><?php echo e($user?->name); ?></span>
                            <span class="block truncate <?php echo e($sidebarProfileEmailClass); ?> text-blue-300"><?php echo e($user?->email); ?></span>
                        </div>
                    </div>

                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="flex w-full items-center justify-center <?php echo e($sidebarLogoutButtonClass); ?> bg-red-600 font-medium text-white shadow-sm transition-colors hover:bg-red-700">
                            <span class="material-symbols-outlined <?php echo e($sidebarLogoutIconClass); ?>">logout</span>
                            Keluar
                        </button>
                    </form>
                </div>
            ...
            <main class="flex min-w-0 flex-1 flex-col overflow-hidden <?php echo e($mainPaddingClass); ?>">
                <header class="sticky top-0 z-30 shrink-0 border-b border-slate-200 bg-white dark:border-white dark:bg-[#10192c]">
                    <div class="flex min-h-[100px] items-center justify-between gap-4 px-4 py-4 sm:px-6 xl:px-8">
                        <div class="flex min-w-0 items-start gap-3">
                            ...
                            <div class="min-w-0">
                                <span class="block truncate text-[24px] font-bold leading-tight text-slate-900 dark:text-white"><?php echo e($pageTitle); ?></span>
                                <span class="mt-1 block truncate text-[14px] font-normal text-slate-500 dark:text-slate-400"><?php echo e($pageSubtitle); ?></span>
                            </div>
                        </div>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3884736183-0', $__key);
...
<?php /**PATH C:\xampp\htdocs\appkonkos-proyek2\resources\views/layouts/mitra/utama.blade.php ENDPATH**/ ?>