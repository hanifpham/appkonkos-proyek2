    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <?php else: ?>
            ...
            <div class="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <a href="<?php echo e(route('properti.detail', ['tipe' => 'kosan', 'id' => $kos->id])); ?>" class="group overflow-hidden rounded-xl bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg block" id="kos-card-<?php echo e($kos->id); ?>">
...
<?php /**PATH C:\xampp\htdocs\appkonkos_2\resources\views/public/partials/kos.blade.php ENDPATH**/ ?>