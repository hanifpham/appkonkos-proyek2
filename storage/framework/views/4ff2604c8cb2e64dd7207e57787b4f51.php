<?php $__env->startSection('mitra-title', 'Riwayat Booking'); ?>
<?php $__env->startSection('mitra-subtitle', 'Pantau transaksi booking yang masuk ke seluruh properti Anda dengan status pembayaran terbaru.'); ?>
    ...
    <section class="grid grid-cols-1 gap-6 md:grid-cols-3">
        <div class="rounded-2xl border border-emerald-100 bg-white p-6 shadow-sm dark:border-emerald-900/30 dark:bg-slate-900">
            ...
            <div class="mt-3 flex items-center justify-between">
                <h3 class="text-3xl font-bold text-slate-900 dark:text-white"><?php echo e($statSettlement); ?></h3>
        ...
        <div class="rounded-2xl border border-amber-100 bg-white p-6 shadow-sm dark:border-amber-900/30 dark:bg-slate-900">
            ...
            <div class="mt-3 flex items-center justify-between">
                <h3 class="text-3xl font-bold text-slate-900 dark:text-white"><?php echo e($statPending); ?></h3>
        ...
        <div class="rounded-2xl border border-rose-100 bg-white p-6 shadow-sm dark:border-rose-900/30 dark:bg-slate-900">
            ...
            <div class="mt-3 flex items-center justify-between">
                <h3 class="text-3xl font-bold text-slate-900 dark:text-white"><?php echo e($statRefunded); ?></h3>
    ...
    <section class="overflow-visible rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    >
                        <span class="flex min-w-0 items-center gap-2">
                            ...
                            <span class="truncate"><?php echo e($this->getActiveFilterLabel()); ?></span>
                        </span>
                    ...
                    >
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $filterOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button
                                type="button"
                            ...
                            >
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($statusFilter === $value): ?>
            ...
            <table class="min-w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <tr wire:key="booking-history-<?php echo e($booking->id); ?>" class="align-top transition hover:bg-slate-50/80 dark:hover:bg-slate-800/40">
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-3">
                                    <div class="flex h-11 w-11 items-center justify-center rounded-full bg-slate-100 text-sm font-bold text-slate-500 dark:bg-slate-800 dark:text-slate-200">
                                        <?php echo e(strtoupper(substr($penyewa?->name ?? 'P', 0, 1))); ?>

                                    </div>
                                    <div class="min-w-0">
                                        <p class="font-semibold text-slate-900 dark:text-white"><?php echo e($penyewa?->name ?? 'Penyewa'); ?></p>
                                        <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($this->getBookingDisplayId($booking)); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($propertyImageUrl !== ''): ?>
                                        <img src="<?php echo e($propertyImageUrl); ?>" alt="<?php echo e($this->getPropertyName($booking)); ?>" class="h-12 w-12 rounded-xl object-cover">
                                    <?php else: ?>
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div class="min-w-0">
                                        <p class="font-semibold text-slate-800 dark:text-slate-100"><?php echo e($this->getPropertyName($booking)); ?></p>
                                        <p class="text-xs text-slate-500 dark:text-slate-400"><?php echo e($this->getPropertyUnitLabel($booking)); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-5 text-slate-600 dark:text-slate-300">
                                <?php echo e($booking->tgl_mulai_sewa?->locale('id')->translatedFormat('d M Y') ?? '-'); ?>

                            </td>
                            <td class="px-6 py-5">
                                <p class="font-semibold text-slate-900 dark:text-white"><?php echo e($this->formatRupiah($this->getTotalBayar($booking))); ?></p>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRefunded): ?>
                                    <p class="mt-1 text-xs font-semibold text-rose-600 dark:text-rose-300">
                                        Pendapatan Mitra: <?php echo e($this->formatRupiah($this->getPendapatanMitra($booking))); ?>

                                    </p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="px-6 py-5">
                                <span class="<?php echo e($this->getStatusClasses($booking)); ?> inline-flex rounded-full px-3 py-1 text-[11px] font-bold tracking-wide">
                                    <?php echo e($this->getStatusLabel($booking)); ?>

                                </span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRefunded): ?>
                                    <p class="mt-2 max-w-[220px] text-xs leading-5 text-rose-600 dark:text-rose-300">
                                        Booking otomatis batal dan pendapatan Mitra untuk transaksi ini menjadi <?php echo e($this->formatRupiah(0)); ?>.
                                    </p>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="px-6 py-5 text-right">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->canSyncMidtrans($booking)): ?>
                                    <button
                                        type="button"
                                        wire:click="syncMidtrans('<?php echo e($booking->id); ?>')"
                                ...
                                <?php else: ?>
                                    <span class="text-xs text-slate-400 dark:text-slate-500">
                                        <?php echo e($isRefunded ? 'Refund selesai' : 'Tidak ada aksi'); ?>
        ...
        <div class="flex flex-col gap-4 border-t border-slate-200 px-6 py-4 dark:border-slate-800 sm:flex-row sm:items-center sm:justify-between">
            <p class="text-xs text-slate-500 dark:text-slate-400">
                Menampilkan <?php echo e($bookings->firstItem() ?? 0); ?> sampai <?php echo e($bookings->lastItem() ?? 0); ?> dari <?php echo e($bookings->total()); ?> booking
            </p>
...
<?php /**PATH C:\xampp\htdocs\appkonkos_2\resources\views/livewire/mitra/riwayat-booking.blade.php ENDPATH**/ ?>