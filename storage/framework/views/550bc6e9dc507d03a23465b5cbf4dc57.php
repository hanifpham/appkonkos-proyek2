...
<section class="relative flex min-h-[560px] items-center justify-center overflow-hidden pt-16" id="hero-section">
    ...
    <div class="absolute inset-0">
        <img src="<?php echo e(asset('images/hero-bg.png')); ?>" alt="Interior hunian modern" class="h-full w-full object-cover">
    ...
    <div class="relative z-30 mx-auto w-full max-w-7xl px-4 py-20 text-center sm:px-6 lg:px-8">
        ...
        <div class="animate-float-up relative mx-auto mt-10 max-w-4xl">
            <form action="<?php echo e(route('cari')); ?>" method="GET" class="rounded-full bg-white p-2 shadow-[0_20px_50px_rgba(15,79,181,0.12)] md:p-2.5">
...
<?php /**PATH C:\xampp\htdocs\appkonkos_2\resources\views/public/partials/hero.blade.php ENDPATH**/ ?>