...
<section class="bg-white py-16" id="sekitar-kampus">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kampus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('cari', ['lokasi' => $k['nama']])); ?>" class="group flex items-center gap-4 rounded-xl border border-[#e5e7eb] bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#1967d2] hover:shadow-md" id="kampus-<?php echo e(Str::slug($k['abbr'])); ?>">
                    <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center overflow-hidden rounded-full border border-slate-100 bg-white">
                        <img src="<?php echo e($k['logo']); ?>" alt="Logo <?php echo e($k['abbr']); ?>" class="h-full w-full object-cover">
                    </div>
                    <div class="min-w-0 flex-1">
                        <h3 class="truncate text-sm font-bold text-[#090a0b] transition group-hover:text-[#1967d2]"><?php echo e($k['abbr']); ?></h3>
                        <p class="truncate text-xs text-[#6b7280]"><?php echo e($k['kota']); ?></p>
                    </div>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            
            
            <a href="<?php echo e(route('cari')); ?>" class="group flex items-center justify-center rounded-xl border border-[#e5e7eb] bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#1967d2] hover:shadow-md" id="kampus-lihat-semua">
                <span class="text-sm font-bold text-[#090a0b] transition group-hover:text-[#1967d2]">Lihat semua &rarr;</span>
            </a>
        </div>
    </div>
</section>
<?php /**PATH C:\xampp\htdocs\appkonkos-proyek2\resources\views/public/partials/kampus.blade.php ENDPATH**/ ?>