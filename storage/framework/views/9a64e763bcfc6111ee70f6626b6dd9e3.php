            ...
            <div x-data="{ open: false }" class="relative sm:w-auto">
                ...
                >
                    <span class="flex min-w-0 items-center gap-2">
                        ...
                        <span class="truncate"><?php echo e($activeFilterLabel); ?></span>
                    </span>
                ...
                >
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $filterOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button
                            type="button"
                            wire:click="$set('filter', '<?php echo e($option); ?>')"
                            @click="open = false"
                        ...
                        >
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filter === $option): ?>
