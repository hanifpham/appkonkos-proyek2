                ...
                <div class="space-y-6">
                    <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                        ...
                        <div class="mt-5 space-y-4">
                            ...
                            <p class="text-xs leading-5 text-slate-500 dark:text-slate-400">Anda dapat memilih hingga 5 foto (Tahan tombol Ctrl/Cmd untuk memilih banyak file). <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editId === null): ?>Kolom ini wajib diisi. <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?> Maksimal 2MB per foto, format JPG, JPEG, PNG, atau WEBP. Jika Anda mengunggah foto baru, foto lama akan tertimpa.</p>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                                ...
                                <div class="overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700">
                                    <img src="<?php echo e($url); ?>" alt="Foto kosan saat ini" class="h-32 w-full object-cover">
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <?php else: ?>
...
</div><?php /**PATH C:\xampp\htdocs\appkonkos_2\resources\views/livewire/mitra/properti/form-kosan.blade.php ENDPATH**/ ?>