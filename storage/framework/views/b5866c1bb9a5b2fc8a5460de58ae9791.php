                ...
                <div class="space-y-6">
                    <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                        ...
                        <div class="mt-5 space-y-4">
                            ...
                            >
                            <p class="text-xs leading-5 text-slate-500 dark:text-slate-400">Pilih foto utama yang paling mewakili tampilan kontrakan. <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($editId === null): ?>Kolom ini wajib diisi. <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?> Maksimal 2MB, format JPG, JPEG, PNG, atau WEBP.</p>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($foto_properti): ?>
                                <div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700">
                                    <img src="<?php echo e($foto_properti->temporaryUrl()); ?>" alt="Preview foto kontrakan" class="h-60 w-full object-cover">
                                </div>
                            <?php elseif($existingPhotoUrl): ?>
                                <div class="overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700">
                                    <img src="<?php echo e($existingPhotoUrl); ?>" alt="Foto kontrakan saat ini" class="h-60 w-full object-cover">
                                </div>
                            <?php else: ?>
...
<?php /**PATH C:\xampp\htdocs\appkonkos-proyek2\resources\views/livewire/mitra/properti/form-kontrakan.blade.php ENDPATH**/ ?>