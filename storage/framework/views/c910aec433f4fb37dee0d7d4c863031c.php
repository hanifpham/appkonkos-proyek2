...
<nav x-data="{
    ...
    <div class="mx-auto flex max-w-[1400px] items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <a href="<?php echo e(route('home')); ?>" class="group flex items-center gap-3" id="nav-logo">
        ...
        <div class="hidden items-center gap-2 md:flex">
            <a href="<?php echo e(route('home')); ?>" class="rounded-full px-5 py-2.5 text-sm font-bold text-slate-600 transition-all hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-blue-300" id="nav-beranda">Beranda</a>
            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false" @mouseleave="open = false" @mouseenter="open = true">
                ...
                <div x-show="open" x-cloak
                    ...
                    <a href="<?php echo e(route('cari', ['tipe' => 'Kos'])); ?>" class="group flex items-center gap-4 rounded-xl p-3 transition-colors hover:bg-blue-50 dark:hover:bg-slate-800" id="nav-cari-kos">
                    ...
                    <a href="<?php echo e(route('cari', ['tipe' => 'Kontrakan'])); ?>" class="group mt-1 flex items-center gap-4 rounded-xl p-3 transition-colors hover:bg-orange-50 dark:hover:bg-slate-800" id="nav-cari-kontrakan">
            ...
            <a href="<?php echo e(route('pusat-bantuan')); ?>" class="rounded-full px-5 py-2.5 text-sm font-bold text-slate-600 transition-all hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-blue-300" id="nav-bantuan">Pusat Bantuan</a>
        </div>
...
[$__name, $__params] = $__split('common.notification-bell', []);

$__key = null;

$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1896379166-0', $__key);
...
?>
                ...
                <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                    <button @click="open = !open" class="flex items-center gap-2 rounded-full border border-slate-200/80 bg-white py-1.5 pl-1.5 pr-2.5 shadow-sm transition-all hover:border-slate-300 hover:shadow-md dark:border-slate-700 dark:bg-slate-800 dark:hover:border-slate-600" aria-label="Menu profil">
                        <img src="<?php echo e($navProfilePhoto); ?>" alt="<?php echo e($navUser->name); ?>" class="h-9 w-9 rounded-full object-cover ring-2 ring-white dark:ring-slate-700" data-appkonkos-profile-photo onerror="this.onerror=null;this.src='<?php echo e($navProfileFallbackPhoto); ?>';">
                    ...
                    <div x-show="open" x-cloak
                        ...
                        <div class="bg-gradient-to-br from-[#1967d2] to-sky-500 px-5 py-4">
                            <div class="flex items-center gap-3">
                                <img src="<?php echo e($navProfilePhoto); ?>" alt="<?php echo e($navUser->name); ?>" class="h-12 w-12 rounded-full object-cover ring-2 ring-white/40 shadow-lg" data-appkonkos-profile-photo>
                                <div class="min-w-0 flex-1">
                                    <p class="truncate text-sm font-bold text-white"><?php echo e($navUser->name); ?></p>
                                    <p class="truncate text-xs text-blue-100"><?php echo e($navUser->email); ?></p>
                                </div>
                            </div>
                        </div>

                        <div class="py-2">
                            <a href="<?php echo e(route('pencari.profil')); ?>" wire:navigate class="flex items-center gap-3 px-5 py-2.5 text-sm font-medium text-slate-700 transition-colors hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-300 dark:hover:bg-slate-700/50 dark:hover:text-blue-400">
                            ...
                            <a href="<?php echo e(route('pencari.favorit')); ?>" wire:navigate class="flex items-center gap-3 px-5 py-2.5 text-sm font-medium text-slate-700 transition-colors hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-300 dark:hover:bg-slate-700/50 dark:hover:text-blue-400">
                                <svg class="h-[18px] w-[18px] text-slate-400 dark:text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                                </svg>
                                Favorit Saya
                            </a>
                            <a href="<?php echo e(route('pencari.riwayat-pesanan')); ?>" wire:navigate class="flex items-center gap-3 px-5 py-2.5 text-sm font-medium text-slate-700 transition-colors hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-300 dark:hover:bg-slate-700/50 dark:hover:text-blue-400">
                                <svg class="h-[18px] w-[18px] text-slate-400 dark:text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                                Riwayat Pesanan
                            </a>
                            <a href="<?php echo e(route('pencari.ulasan-saya')); ?>" wire:navigate class="flex items-center gap-3 px-5 py-2.5 text-sm font-medium text-slate-700 transition-colors hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-300 dark:hover:bg-slate-700/50 dark:hover:text-blue-400">
                                <svg class="h-[18px] w-[18px] text-slate-400 dark:text-slate-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div x-show="mobileOpen" x-cloak
        ...
        <div class="space-y-2">
            <a href="<?php echo e(route('home')); ?>" class="block rounded-xl px-4 py-3 text-base font-bold text-slate-800 transition-colors hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-100 dark:hover:bg-slate-800 dark:hover:text-blue-300">Beranda</a>
            ...
            <div x-data="{ cariMobileOpen: false }" class="space-y-1">
                ...
                <div x-show="cariMobileOpen" x-cloak class="pl-4 pr-2">
                    <a href="<?php echo e(route('cari', ['tipe' => 'Kos'])); ?>" class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold text-slate-600 transition-colors hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-blue-300">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0h4" />
                        </svg>
                        Cari Kos
                    </a>
                    <a href="<?php echo e(route('cari', ['tipe' => 'Kontrakan'])); ?>" class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold text-slate-600 transition-colors hover:bg-orange-50 hover:text-[#ff8a00] dark:text-slate-300 dark:hover:bg-slate-800">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                        </svg>
                        Cari Kontrakan
            ...
            <a href="<?php echo e(route('pusat-bantuan')); ?>" class="block rounded-xl px-4 py-3 text-base font-bold text-slate-800 transition-colors hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-100 dark:hover:bg-slate-800 dark:hover:text-blue-300">Pusat Bantuan</a>
        ...
        <div class="mt-6 border-t border-slate-100 pt-6 dark:border-slate-800">
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center gap-3 rounded-2xl bg-gradient-to-br from-[#1967d2] to-sky-500 px-4 py-3.5">
                    <img src="<?php echo e($navProfilePhoto); ?>" alt="<?php echo e($navUser->name); ?>" class="h-11 w-11 rounded-full object-cover ring-2 ring-white/40 shadow-lg" data-appkonkos-profile-photo>
                    <div class="min-w-0 flex-1">
                        <div class="truncate text-sm font-bold text-white"><?php echo e($navUser->name); ?></div>
                        <div class="truncate text-xs text-blue-100"><?php echo e($navUser->email); ?></div>
                    </div>
                </div>

                <a href="<?php echo e(route('pencari.profil')); ?>" wire:navigate class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold text-slate-600 transition-colors hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-blue-400">
                    <svg class="h-5 w-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                    Profil Saya
                </a>
                <a href="<?php echo e(route('pencari.favorit')); ?>" wire:navigate class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold text-slate-600 transition-colors hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-blue-400">
                    <svg class="h-5 w-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                    </svg>
                    Favorit Saya
                </a>
                <a href="<?php echo e(route('pencari.riwayat-pesanan')); ?>" wire:navigate class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold text-slate-600 transition-colors hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-blue-400">
                    <svg class="h-5 w-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    Riwayat Pesanan
                </a>
                <a href="<?php echo e(route('pencari.ulasan-saya')); ?>" wire:navigate class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold text-slate-600 transition-colors hover:bg-blue-50 hover:text-[#1967d2] dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-blue-400">
                    <svg class="h-5 w-5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                    </svg>
                    Ulasan Saya
...
<?php echo $__env->make('public.partials.login-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\appkonkos-proyek2\resources\views/public/partials/navbar.blade.php ENDPATH**/ ?>