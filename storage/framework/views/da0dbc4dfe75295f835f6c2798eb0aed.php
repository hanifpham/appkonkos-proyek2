    ...
    <div class="mx-auto w-full max-w-6xl space-y-8 pb-16">
        ...
        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                >
                    <a href="<?php echo e(route('mitra.properti.tambah-kosan')); ?>" class="block px-4 py-3 text-sm font-medium text-gray-700 transition hover:bg-sky-50 hover:text-sky-700 dark:text-gray-200 dark:hover:bg-slate-800">
                        Tambah Kos
                    </a>
                    <a href="<?php echo e(route('mitra.properti.tambah-kontrakan')); ?>" class="block px-4 py-3 text-sm font-medium text-gray-700 transition hover:bg-sky-50 hover:text-sky-700 dark:text-gray-200 dark:hover:bg-slate-800">
                        Tambah Kontrakan
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\appkonkos_2\resources\views/livewire/mitra/properti/daftar-properti.blade.php ENDPATH**/ ?>