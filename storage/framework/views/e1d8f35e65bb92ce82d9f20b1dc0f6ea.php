<div class="flex h-screen w-full overflow-hidden bg-white">
    ...
    <div class="hidden w-1/2 flex-col items-center justify-center bg-[#1967d2] p-8 text-center text-white lg:flex">
        ...
        <img src="<?php echo e(asset('images/illustration-1.svg')); ?>" alt="Illustration" class="max-h-64 object-contain opacity-90" onerror="this.src='https://illustrations.popsy.co/blue/freelancer.svg'">
    </div>
...
<?php /**PATH C:\xampp\htdocs\appkonkos_2\resources\views/components/autentikasi/kartu-autentikasi.blade.php ENDPATH**/ ?>