        ...
        <section @click.outside="loginModalOpen = false" class="relative w-full max-w-[640px] overflow-hidden rounded-[2.5rem] bg-white shadow-[0_20px_80px_rgba(0,0,0,0.2)]">
            ...
            <div class="relative px-6 py-10 sm:px-12 sm:py-14">
                ...
                <div class="text-center">
                    <div class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-white shadow-md shadow-blue-500/15 ring-2 ring-[#1967d2]/20 transition-all duration-300 group-hover:scale-105 group-hover:shadow-blue-500/30 group-hover:ring-[#1967d2]/40">
                        <img src="<?php echo e(asset('images/appkonkos.png')); ?>" alt="<?php echo e(config('app.name', 'APPKONKOS')); ?>" class="h-10 w-10 object-contain">
                    </div>
...
</div><?php /**PATH C:\xampp\htdocs\appkonkos-proyek2\resources\views/public/partials/login-modal.blade.php ENDPATH**/ ?>